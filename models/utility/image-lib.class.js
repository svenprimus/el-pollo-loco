export class ImageLib {
    ...
    static COIN = {
        ...
        rotate: [
            './assets/sprites/8_coin/rotate/R-1.png',
            './assets/sprites/8_coin/rotate/R-2.png',
            './assets/sprites/8_coin/rotate/R-3.png',
            './assets/sprites/8_coin/rotate/R-4.png',
            './assets/sprites/8_coin/rotate/R-5.png',
        ],
    };
    ...
    static SCREENS = {
        start: {
            wNatural: 1920,
            hNatural: 1080,
            img: './assets/sprites/9_intro_outro_screens/start/startscreen_1.png',
        },
        gameOver: {
            wNatural: 1143,
            hNatural: 674,
            img: './assets/sprites/You won, you lost/Game Over.png',
        },
        won: {
            wNatural: 987,
            hNatural: 879,
            img: './assets/sprites/You won, you lost/You won A.png',
        },
    };
}
